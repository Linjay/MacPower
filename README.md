...
当前版本：**MacPower 0.1.1 预览版**，按选定的方案 1 · Power Path 实现原生菜单栏程序，读取真实设备数据。支持电源输入、电池充放电、整机耗电、健康度与循环次数，包含历史曲线、CSV 导出，以及深色、浅色、跟随系统三种外观。

## 使用原生应用

从 [Release v0.1.1](https://github.com/Linjay/MacPower/releases/tag/v0.1.1) 下载 `MacPower-0.1.1-arm64.zip`，解压后将 `MacPower.app` 放入“应用程序”并双击打开。此构建适用于 Apple Silicon Mac；源码最低部署目标为 macOS 14，实际验证环境是 macOS 27.0。
